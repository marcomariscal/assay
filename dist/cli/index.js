...
import { analyzeContract, formatAnalysis } from "../chunk-OFKWHJGT.js";

var VALID_CHAINS = ["ethereum", "base", "arbitrum", "optimism", "polygon"];
...
program
	...
	.action(async (address, options) => {
		...
		if (!VALID_CHAINS.includes(chain)) {
			console.error(`Invalid chain: ${chain}. Valid options: ${VALID_CHAINS.join(", ")}`);
			process.exit(1);
		}
